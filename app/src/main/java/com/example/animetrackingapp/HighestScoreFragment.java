...
public class HighestScoreFragment extends Fragment implements View.OnClickListener {

    public HighestScoreFragment(){}

    @Override
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_highest_score, container, false);
        InitAnime(v);
        return v;
    }
    ...
    private void InitAnime(View v){
        Api.getJSON("https://api.jikan.moe/v3/search/anime?q=&order_by=score&sort=desc", new ReadDataHandler(){
            @Override
            public void handleMessage(Message message) {
                ...
                try{
                    ...
                    for(AnimeModel a : anime){
                        ...
                        item.setOnClickListener(HighestScoreFragment.this);
